...
public class SignUpOnePermissionListener implements PermissionListener {

    private final WeakReference<SignUpOneActivity> activity;

    public SignUpOnePermissionListener(SignUpOneActivity activity) {
