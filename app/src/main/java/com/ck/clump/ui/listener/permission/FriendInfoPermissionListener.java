...
/**
 * Created by Nhat on 5/13/17.
 */

public class FriendInfoPermissionListener implements PermissionListener {

    private final WeakReference<FriendInfoActivity> activity;

    public FriendInfoPermissionListener(FriendInfoActivity activity) {
