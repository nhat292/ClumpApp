package com.ck.clump.ui.widget.navigationbar;
...
public class NavigationTabBar extends View implements ViewPager.OnPageChangeListener {
    ...
    protected final NavigationTabBar.ResizeInterpolator mResizeInterpolator = new NavigationTabBar.ResizeInterpolator();
    protected int mAnimationDuration;

    // NTB models
    protected final List<NavigationTabBar.Model> mModels = new ArrayList<>();
    ...
    // Tab listener
    protected NavigationTabBar.OnTabBarSelectedIndexListener mOnTabBarSelectedIndexListener;
    ...
    protected NavigationTabBar.TitleMode mTitleMode;
    // Model badge position: left, center or right
    protected NavigationTabBar.BadgePosition mBadgePosition;
    // Model badge gravity: top or bottom
    protected NavigationTabBar.BadgeGravity mBadgeGravity;
    ...
    public NavigationTabBar(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        ...
        try {
            ...
            setTitleMode(
                    typedArray.getInt(
                            R.styleable.NavigationTabBar_ntb_title_mode, NavigationTabBar.TitleMode.ALL_INDEX
                    )
            );
            setBadgeSize(
            ...
            setBadgePosition(
                    typedArray.getInt(
                            ...
                            NavigationTabBar.BadgePosition.RIGHT_INDEX
                    )
            );
            setBadgeGravity(
                    typedArray.getInt(
                            R.styleable.NavigationTabBar_ntb_badge_gravity, NavigationTabBar.BadgeGravity.TOP_INDEX
                    )
            );
            setBadgeBgColor(
            ...
            if (isInEditMode()) {
                ...
                try {
                    ...
                    for (String previewColor : previewColors)
                        mModels.add(new NavigationTabBar.Model.Builder(null, Color.parseColor(previewColor)).build());
                    requestLayout();
                }
            }
        } finally {
    ...
    public List<NavigationTabBar.Model> getModels() {
        return mModels;
    }

    public void setModels(final List<NavigationTabBar.Model> models) {
        //Set update listeners to badge model animation
        for (final NavigationTabBar.Model model : models) {
    ...
    public NavigationTabBar.TitleMode getTitleMode() {
        return mTitleMode;
    }

    protected void setTitleMode(final int index) {
        switch (index) {
            case NavigationTabBar.TitleMode.ACTIVE_INDEX:
                setTitleMode(NavigationTabBar.TitleMode.ACTIVE);
                break;
            case NavigationTabBar.TitleMode.ALL_INDEX:
            default:
                setTitleMode(NavigationTabBar.TitleMode.ALL);
                break;
        }
    }

    public void setTitleMode(final NavigationTabBar.TitleMode titleMode) {
        mTitleMode = titleMode;
        postInvalidate();
    }

    public NavigationTabBar.BadgePosition getBadgePosition() {
        return mBadgePosition;
    }

    protected void setBadgePosition(final int index) {
        switch (index) {
            case NavigationTabBar.BadgePosition.LEFT_INDEX:
                setBadgePosition(NavigationTabBar.BadgePosition.LEFT);
                break;
            case NavigationTabBar.BadgePosition.CENTER_INDEX:
                setBadgePosition(NavigationTabBar.BadgePosition.CENTER);
                break;
            case NavigationTabBar.BadgePosition.RIGHT_INDEX:
            default:
                setBadgePosition(NavigationTabBar.BadgePosition.RIGHT);
                break;
        }
    }

    public void setBadgePosition(final NavigationTabBar.BadgePosition badgePosition) {
        mBadgePosition = badgePosition;
        postInvalidate();
    }

    public NavigationTabBar.BadgeGravity getBadgeGravity() {
        return mBadgeGravity;
    }

    protected void setBadgeGravity(final int index) {
        switch (index) {
            case NavigationTabBar.BadgeGravity.BOTTOM_INDEX:
                setBadgeGravity(NavigationTabBar.BadgeGravity.BOTTOM);
                break;
            case NavigationTabBar.BadgeGravity.TOP_INDEX:
            default:
                setBadgeGravity(NavigationTabBar.BadgeGravity.TOP);
                break;
        }
    }

    public void setBadgeGravity(final NavigationTabBar.BadgeGravity badgeGravity) {
    ...
    public NavigationTabBar.OnTabBarSelectedIndexListener getOnTabBarSelectedIndexListener() {
    ...
    public void setOnTabBarSelectedIndexListener(
            final NavigationTabBar.OnTabBarSelectedIndexListener onTabBarSelectedIndexListener
    ) {
    ...
    protected void resetScroller() {
        ...
        try {
            ...
            final NavigationTabBar.ResizeViewPagerScroller scroller = new NavigationTabBar.ResizeViewPagerScroller(getContext());
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        final float barBadgeMargin = mBadgeGravity == NavigationTabBar.BadgeGravity.TOP ? mBadgeMargin : 0.0F;
        mBgBounds.set(0.0F, barBadgeMargin, mBounds.width(), mBounds.height() + barBadgeMargin);

        // Set scale fraction for icons
        for (NavigationTabBar.Model model : mModels) {
            ...
            if (isInEditMode()) {
                ...
                if (mIsBadged)
                    for (int i = 0; i < mModels.size(); i++) {
                        final NavigationTabBar.Model model = mModels.get(i);
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        for (int i = 0; i < mModels.size(); i++) {
            ...
            model.mIconMatrix.setTranslate(
                    leftOffset,
                    (mIsTitled && mTitleMode == NavigationTabBar.TitleMode.ALL) ? titleTranslate : topOffset
            );
        ...
        final float modelBadgeMargin =
                mBadgeGravity == NavigationTabBar.BadgeGravity.TOP ? mBadgeMargin : mBounds.height();
        final float modelBadgeOffset =
                mBadgeGravity == NavigationTabBar.BadgeGravity.TOP ? 0.0F : mBounds.height() - mBadgeMargin;
    ...
    protected void updateCurrentModel(
            final NavigationTabBar.Model model,
            final float leftOffset,
            final float topOffset,
            final float titleTranslate,
            final float interpolation,
        ...
        if (mIsTitled && mTitleMode == NavigationTabBar.TitleMode.ACTIVE) model.mIconMatrix.setTranslate(
        ...
        if (mTitleMode == NavigationTabBar.TitleMode.ACTIVE) mModelTitlePaint.setAlpha(titleAlpha);
    ...
    protected void updateLastModel(
        ...
        if (mTitleMode == NavigationTabBar.TitleMode.ACTIVE) mModelTitlePaint.setAlpha(titleLastAlpha);
    ...
    protected void updateInactiveModel(
        ...
        if (mIsTitled && mTitleMode == NavigationTabBar.TitleMode.ACTIVE)
        ...
        if (mTitleMode == NavigationTabBar.TitleMode.ACTIVE) mModelTitlePaint.setAlpha(MIN_ALPHA);
    ...
    public void onRestoreInstanceState(Parcelable state) {
        final NavigationTabBar.SavedState savedState = (NavigationTabBar.SavedState) state;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        final NavigationTabBar.SavedState savedState = new NavigationTabBar.SavedState(superState);
    ...
    protected static class SavedState extends BaseSavedState {
        ...
        public static final Creator<NavigationTabBar.SavedState> CREATOR = new Creator<NavigationTabBar.SavedState>() {
            @Override
            public NavigationTabBar.SavedState createFromParcel(Parcel in) {
                return new NavigationTabBar.SavedState(in);
            }

            @Override
            public NavigationTabBar.SavedState[] newArray(int size) {
                return new NavigationTabBar.SavedState[size];
            }
        };
    }
    ...
    public static class Model {
        ...
        Model(final NavigationTabBar.Model.Builder builder) {
        ...
        public static class Builder {
            ...
            public NavigationTabBar.Model.Builder selectedIcon(final Drawable selectedIcon) {
            ...
            public NavigationTabBar.Model.Builder title(final String title) {
                mTitle = title;
                return this;
            }

            public NavigationTabBar.Model.Builder badgeTitle(final String title) {
                mBadgeTitle = title;
                return this;
            }

            public NavigationTabBar.Model build() {
                return new NavigationTabBar.Model(this);
            }
        }
    }
    ...
    public interface OnTabBarSelectedIndexListener {
        void onStartTabSelected(final NavigationTabBar.Model model, final int index);

        void onEndTabSelected(final NavigationTabBar.Model model, final int index);
    }
}
