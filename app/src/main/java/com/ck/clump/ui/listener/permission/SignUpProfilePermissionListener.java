...
public class SignUpProfilePermissionListener implements PermissionListener {

    private final WeakReference<SignUpProfileActivity> activity;

    public SignUpProfilePermissionListener(SignUpProfileActivity activity) {
