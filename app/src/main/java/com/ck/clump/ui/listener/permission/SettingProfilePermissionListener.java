...
public class SettingProfilePermissionListener implements PermissionListener {

    private final WeakReference<SettingProfileActivity> activity;

    public SettingProfilePermissionListener(SettingProfileActivity activity) {
